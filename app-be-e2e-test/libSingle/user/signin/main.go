...
import (
	...
	dto "diskon-hunter/price-monitoring-e2e-test/shared/delivery/user/signin"
...
var DefaultRequestObject = GenerateRequestObject(GenerateRequestObjectArgs{
	Email:    "diskon.hunter.e2e.test@yopmail.com",
	Password: "Test123!",
})
...
func Execute(body dto.RequestDTOV1) (result ExecuteResult, err error) {
	...
	result.JWTCookieString = res.Header.Get("Set-Cookie")
