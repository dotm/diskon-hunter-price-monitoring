...
type QueryV1DataResponse = []searchedItem.StlUserSearchesItemDetailDAOV1
...
func QueryV1Handler(
	...
	*/
	...
	userSearchesItemList, errObj, err := dynamodbhelper.GetUserSearchesItemListOfUserId(
	...
	*/
	return userSearchesItemList, nil
}
